...
module.exports = {
    ...
    ownerOnly: true,  // ← ensures only the owner can run it
    ...
    execute: async (sock, m, { reply, text }) => {
        ...
        switch (subCmd) {
            ...
            case 'fund':
                ...
                workingMsg = '_✪ Fetching funding info..._';
